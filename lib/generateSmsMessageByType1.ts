...
export function generateSmsMessageByType(
  ...
  //     ? `\n\nלניווט ב-Waze: ${wazeLink || "לא זמין"}\nהוראות הגעה ב-Google Maps: ${googleMapsLink || "לא זמין"}`
  //     : "";
...
טרם קיבלנו מכם אישור הגעה ל${eventType || "האירוע"} של ${celebrants} שיתקיים ב־${date}.
...
האירוע מתחיל בקרוב! ${eventType || "האירוע"} של ${celebrants} יתקיים היום ${fullLocation}.

הושבתם לשולחן מספר ${table}.${wazeText}.${googleMapsText}
