...
export default function Reviews() {
  return (
    <div
      dir="rtl"
      className="flex flex-col items-center justify-center min-h-screen py-8 mt-17"
    >
      <h1 className="text-4xl font-bold mb-8">חוות דעת</h1>
      <div className="w-full max-w-2xl space-y-8">
        <div className="bg-white text-black rounded-lg shadow p-6">
          <p className="mb-2">
            "פלטפורמה מדהימה! הפכה את תכנון האירוע שלי לקל ומהנה."
          </p>
        ...
        <div className="bg-white text-black rounded-lg shadow p-6">
          <p className="mb-2">"אפשר לסכם במילה אחת - אומנות"</p>
          <span className="font-semibold">- חיים נ.</span>
        </div>
      </div>
    </div>
  );
