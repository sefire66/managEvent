...
const EventDetailsBrit = ({
  ...
  return (
    <div
      className="grid grid-cols-1 sm:grid-cols-2 gap-x-2 gap-y-1 w-full max-w-full px-2 mx-auto text-right items-top"
      dir="rtl"
    >
      <InputBox1
        name="brideFirst"
        titleName="שמות ההורים"
        value={details.brideFirst || ""}
        onChange={onChange}
        showError={isRequired?.("brideFirst") && !details.brideFirst}
        placeholder="למשל: תמר ויוסי כהן"
      />
      <div className="w-[160px] h-[32px] "></div>
...
export default EventDetailsBrit;
