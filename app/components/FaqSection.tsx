    ...
    a: (
      <>
        <ol className="list-decimal ms-6">
          <li>
            בחלק של <strong>ניהול אורחים</strong> לוחצים על{" "}
            <strong>הורד תבנית אקסל</strong>, מעדכנים בקובץ שמות וטלפונים
            ושומרים.
          </li>
          <li>
            לחיצה על <strong>העלה קובץ אקסל</strong> תפתח תפריט בחירת קבצים,
            בוחרים את הקובץ שלנו ולוחצים אישור.
          </li>
        </ol>
        <ul className="list-disc ms-6 space-y-2">
          <li>
            <p className="text-sm text-gray-700">
              💡 ניתן להוסיף אורח ידני אחד-אחד על ידי לחיצה על לחצן{" "}
              <strong>הוסף אורח</strong>.
            </p>
          </li>
          <li>
            <p className="text-red-500 font-semibold">
              ⚠️ שימו לב: כאשר מעלים קובץ חדש הוא מחליף/מוחק את הרשימה הקודמת.
              אם ברצונכם להוסיף כמות נוספת של אורחים, קודם הורידו את הרשימה
              הקיימת בעזרת <strong>ייצא לאקסל</strong>, עדכנו את הקובץ ואז העלו
              אותו בחזרה.
            </p>
          </li>
          <li>
            <p className="mt-2 text-red-500 font-semibold">
              ❗ אין לשנות את מבנה הקובץ – יש להשאיר את הכותרות כפי שהן.
            </p>
          </li>
          <li>
            <p className="mt-2 text-green-600 font-semibold">
              ✔️ מותר וגם רצוי לשנות את שם הקובץ.
            </p>
          </li>
        </ul>
        <br />
